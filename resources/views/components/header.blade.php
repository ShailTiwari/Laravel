...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/vendors/simple-line-icons/css/simple-line-icons.css') }}">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h4 class="welcome-text">Hi, <span class="text-black fw-bold">{{session('user')}}</span></h4>
          </li>
        </ul>
