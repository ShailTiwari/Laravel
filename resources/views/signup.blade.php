        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="fw-light">Sign Up and continue.</h6>
                <form class="pt-3" name="signup" method="post" action="{{ route('ragister.post') }}">
                    @csrf
                <div class="form-group"> 
                  <input name="name" type="name" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Name">
                </div>
                 <div class="form-group">
